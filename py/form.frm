...
Symbols s,t,u,dim,m1,...,m3,U,MU,MX,MXs,MUs,Q,gs,L#C,R#C,LG#C,RG#C,MG,Tr,Nc,Cf,Ca,dr;
dimension dim;
...
Tensors f(antisymmetric),polsum(symmetric);
Function PL,PR,df,da,VF;
CFunctions C,C0,C1,C2,C00,C11,C12,C22,T,A,B,D;
Indices a,gamma,o,n,m,tm,tn,beta,b,betap,alphap,a,alpha,ind,delta,k,j,l,c,d;
...
+C(tm)*(1/64*g_(1,7_,tm)*T(a,beta,alpha)*pb(mu)*i_*pi_^-2*gs^3*LG^2*Ca^-1+1/32*g_(1,7_,tm)*T(a,beta,alpha)*ll(mu)*i_*pi_^-2*gs^3*LG^2*Ca^-1+1/32*g_(1,7_,tm)*T(a,beta,alpha)*pa(mu)*i_*pi_^-2*gs^3*LG^2*Ca^-1+1/64*g_(1,6_,tm)*T(a,beta,alpha)*pb(mu)*i_*pi_^-2*gs^3*RG^2*Ca^-1+1/32*g_(1,6_,tm)*T(a,beta,alpha)*ll(mu)*i_*pi_^-2*gs^3*RG^2*Ca^-1+1/32*g_(1,6_,tm)*T(a,beta,alpha)*pa(mu)*i_*pi_^-2*gs^3*RG^2*Ca^-1);;
