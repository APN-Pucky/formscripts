...
+C(tm)*(1/64*g_(1,7_,tm)*T(a,beta,alpha)*pb(mu)*i_*pi_^-2*gs^3*LG^2*Ca^-1+1/32*g_(1,7_,tm)*T(a,beta,alpha)*pa(mu)*i_*pi_^-2*gs^3*LG^2*Ca^-1+1/64*g_(1,6_,tm)*T(a,beta,alpha)*pb(mu)*i_*pi_^-2*gs^3*RG^2*Ca^-1+1/32*g_(1,6_,tm)*T(a,beta,alpha)*pa(mu)*i_*pi_^-2*gs^3*RG^2*Ca^-1)+C(tm,mu)*(1/32*g_(1,7_,tm)*T(a,beta,alpha)*i_*pi_^-2*gs^3*LG^2*Ca^-1+1/32*g_(1,6_,tm)*T(a,beta,alpha)*i_*pi_^-2*gs^3*RG^2*Ca^-1);;
